...
def _compute_daily_market(
    ...
    frame["ret_1d"] = frame[close_col].groupby(level="instrument").pct_change()
    ...
    daily_market["size_style_spread"] = frame.groupby("datetime").apply(_size_style_return)
...
def _build_train_context(
    ...
    trend_mean = _safe_float(train_window["trend_20d"].mean())
    vol_rank_mean = _safe_float(train_window["vol_rank_250d"].mean())
    amount_rank_mean = _safe_float(train_window["amount_rank_250d"].mean())
    dispersion_rank_mean = _safe_float(train_window["dispersion_rank_250d"].mean())
    breadth_mean = _safe_float(train_window["breadth_up_ratio"].mean())
    style_mean = _safe_float(train_window["size_style_spread"].mean())
    ...
    return {
        ...
        "stats": {
            ...
            "turnover_rank_250d_mean": _safe_float(train_window["turnover_rank_250d"].mean()),
...
def run() -> None:
    ...
    daily_market = _compute_daily_market(raw_frame, fields=fields, windows=windows)
    ...
    market_context = {
        ...
        "train_context": _build_train_context(train_window, thresholds),
    }
