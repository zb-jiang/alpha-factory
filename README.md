...
Factor Factory 是一套**端到端的量化因子挖掘流水线**，利用大语言模型（LLM）自动生成、验证、评估和筛选选股因子。系统覆盖从数据获取到因子回测的完整链路，支持多窗口训练、样本外盲测、第三方平台校验，并提供 Web 管理界面进行多任务编排。
...
```powershell
# 设置 Staging 目录
$env:STAGING_DIR="D:\test\factor-factory\runtime"
...
8 篇系统化的量化入门教程，从零开始讲解因子投资的核心概念。教程为**知识星球专属内容**，加入知识星球即可获取完整教程：
...
<!-- 知识星球推广位 - 开始 -->
> 🌟 **加入知识星球，获取更多量化因子挖掘的深度内容**
>
> - 独家因子挖掘技巧与实战案例
> - LLM + 量化投资的前沿探索
> - 社群答疑与代码交流
>
> 🔗 知识星球链接：[占位符 - 替换为你的知识星球链接]
>
> 📱 扫码加入：
>
> ![知识星球二维码](占位符 - 替换为二维码图片路径)
<!-- 知识星球推广位 - 结束 -->

### 其他联系方式

- 🐛 问题反馈：[GitHub Issues](占位符 - 替换为你的 GitHub 仓库 Issues 链接)
- 💬 讨论交流：[GitHub Discussions](占位符 - 替换为你的 GitHub Discussions 链接)
